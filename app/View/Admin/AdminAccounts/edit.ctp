	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="x_panel">
				...
				<?php echo $this->Form->create('MasterUser', array('class' => 'form-horizontal form-label-left', 'inputDefaults' => array('label' => false, 'div' => false), 'id' => 'demo-form', 'autocomplete' => 'off', 'onsubmit' => "return confirm(\"アカウントを更新します。よろしいですか？ \");")); ?>
						...
						<div class="form-group">
							...
							<div class="col-md-5 col-sm-5 col-xs-12">
								<?php echo $this->Form->radio('group_id',$group, array('class' => 'flat', 'legend' => false, 'label' => false)); ?>
							</div>
						</div>
